...
SECRET_KEY = '=md)+)_er69el_cqsazwrfdwcuv&l$mptq$k3&#4qc#7&ix@*^'
...
#This tells Django to look in our profiles_api app, find the model UserProfile and use this for authentication and user registration project
